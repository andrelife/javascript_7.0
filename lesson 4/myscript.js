   ...
   let appData = {
    ...
    checkSavings: function() {
        if (appData.savings == true) {
            let save = +prompt("Какова сумма накоплений?"),
                ...
                appData.manthIncome =  (save/100/12*percent).toFixed(2);
    ...
    chooseOptExpenses: function() {
        for (let i = 1; i < 4; i++) {
            ...
            if( (typeof(expenses)) === 'string' && (typeof(expenses)) != null && expenses != '' 
          && expenses.length < 50){
    ...
    chooseIncome: function() { // выберите доход (дополнительный доход)
        for(let i=0; i < 1; i++){
